...
def startNetwork():
   ...
   c0 = RemoteController('c0', ip='127.0.0.1', port=6653)  # pas encore de controlleur on commente cette ligne
   net = Mininet(topo=topo, link=TCLink, controller=c0) # pas encore de controlleur on commente cette ligne
